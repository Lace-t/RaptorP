...
extern int num_blocks,num_blocks2, tot_blocks, tot_blocks_alloc;
...
extern char RMHD_FILE[256];

extern double MBH, M_UNIT, TIME_INIT, INCLINATION, azimuth;
extern double R_HIGH, R_LOW, Tur_or_Rec, P, Amin, Risco, Router;
