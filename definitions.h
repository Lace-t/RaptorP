...
#define num_pixels_1d 20
#define tot_pixels 400
...
#define turbulence (1)
#define kappa_const 4.0
#define Epsilon turbulence//mechanism for generating nonthermal eletrons
...
#define EPS_RTE 1.//xf: limitation for adaptive optical depth
...
#define CKS (8)  //  cartesian Kerr-Schild,  x1=x, x2=y, and x3=z

// Metric
#define metric (CKS)
#if (metric == BL || metric == KS || metric == CKS || metric == CAR)
...
#define RT_OUTER_CUTOFF (5.) // Outer boundary of rad transfer computation
...
#define OUTER_BOUND_POL (5.) // Stop polarized integration beyond this radius //xf: useless
