...
double a_I(double theta_e, double n_e, double nu, double B, double theta_B,double beta, double sigma);
double a_Q(double theta_e, double n_e, double nu, double B, double theta_B,double beta, double sigma);
double a_V(double theta_e, double n_e, double nu, double B, double theta_B,double beta, double sigma);
